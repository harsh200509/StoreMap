...
export function Storefront() {
  ...
  const { setSelectedProduct } = useMapStore();
  const { products, displayCount, loading, loadingMore, fetchProducts, loadMore } = useProductStore();
                  ...
                  <div className="p-3 flex flex-col flex-1">
                    ...
                    <div className="mt-auto flex gap-2">
                      <Button
                        ...
                        onClick={() => setSelectedProduct(product, 'search')}
                        title="View Details"
                      >
